        ...
        <Col xs={12}>
          ...
          <Row className="mt-5">
            <Col xs={12} md={6} className="">
              ...
              <Row>
                ...
                <Col xs={6} md={7}>
                  ...
                  >
                    <img
                      src="https://cdn-1.webcatalog.io/catalog/zerodha-console/zerodha-console-icon-filled-256.webp?v=1714776598687"
                      alt=""
                      width={"20px"}
                      height={"20px"}
                    />{" "}
            ...
            <Col xs={12} md={6} className="mb-sm-5">
              <p className="mt-xs-5">
                <FontAwesomeIcon icon={faDroplet} className="me-3" /> Commodity
              </p>
              <Row>
                <Col xs={6} md={5} className="border-end pe-md-3 mb-3 mb-md-0">
          ...
          <Row className="my-5">
            <Col xs={12}>
              <p>
                <FontAwesomeIcon icon={faBriefcase} /> Holdings (17)
              </p>
              <Row>
                <Col xs={5} md={6} className="border-end pe-md-3 mb-3 mb-md-0">
                  <p className="text-success line-height-sm">
                    2.24k <span style={{ fontSize: "12px" }}>+16.90%</span>
                  </p>
                  <p className="text-muted mb-0" style={{ fontSize: "14px" }}>
                    P&L
                  </p>
